...
KBUILD_BUILD_TIMESTAMP='' PATH="/usr/lib/ccache/bin:$PATH" env _processor_opt="sandybridge" _disable_debug=y _NUMAdisable=y _nr_cpus=4 _use_auto_optimization='' _localmodcfg=y _cc_harder=y makepkg -s --noconfirm
